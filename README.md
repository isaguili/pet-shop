...
- Criar uma **interface de agenda diária** para um pet shop.
- Permitir o **cadastro de novos agendamentos** com informações do pet e do tutor.
- Atualizar dinamicamente os horários disponíveis.
- Possibilitar a **remoção de agendamentos existentes**.
- Trabalhar a **integração com uma API simulada** para armazenar os dados.
